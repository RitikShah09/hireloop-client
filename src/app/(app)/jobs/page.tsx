          ...
          <div className="flex items-start justify-between gap-3">
            <div className="min-w-0 flex-1">
              ...
              {isCompany ? (
                <Link
                  href={`/jobs/${job.id}`}
                  className="text-foreground hover:text-primary transition-micro line-clamp-2 leading-tight font-semibold hover:underline"
                >
                  {job.title}
                </Link>
              ) : (
                <h3 className="text-foreground line-clamp-2 leading-tight font-semibold">
                  {job.title}
                </h3>
              )}
            </div>
