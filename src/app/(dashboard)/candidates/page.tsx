      ...
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex flex-wrap items-center justify-between gap-2">
            <h3 className="text-foreground font-semibold">{candidateName || 'Candidate'}</h3>
      ...
      <div className="border-border mt-4 flex flex-wrap items-center gap-2 border-t pt-3">
        {app.resume && (
          <a href={app.resume.fileUrl} target="_blank" rel="noopener noreferrer">
            <Button variant="outline" size="sm" leftIcon={<ExternalLink size={11} />}>
              Resume
            </Button>
          </a>
        )}
        ...
        {/* Schedule Interview — for candidates not yet rejected or hired */}
